...
/**
 * Title: Work Section
 * Slug: ct-tailwind-theme/work-section
 * Categories: header
...
<!-- wp:group {"className":"mt-20","style":{"color":{"background":"#1e3a8a"},"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}},"layout":{"type":"constrained","contentSize":"1150px","wideSize":"1380px"}} -->
<div class="wp-block-group mt-20 has-background"
    ...
    <div class="wp-block-columns alignwide are-vertically-aligned-center">
        <!-- wp:column {"verticalAlignment":"center","width":"33.33%","className":"rounded-3xl bg-white/5 p-5 shadow-xs transition hover:bg-white/10"} -->
        <div class="wp-block-column is-vertically-aligned-center rounded-3xl bg-white/5 p-5 shadow-xs transition hover:bg-white/10"
